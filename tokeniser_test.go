	...
	for n, test := range [...]struct {
		...
		{ // 2
			...
			[]parser.Token{
				{Type: TokenString, Data: "'escaped newline \\\n'"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenString, Data: "'escaped carriage return \\\r'"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenString, Data: "'escaped form feed \\\f'"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenString, Data: "'escaped crlf \\\r\n'"},
				{Type: parser.TokenDone},
			},
		},
		{ // 3
			...
			[]parser.Token{
				{Type: TokenString, Data: "'escape followed by newline \\A\n'"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenString, Data: "'escape followed by carriage return \\A\r'"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenString, Data: "'escape followed by form feed \\A\f'"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenString, Data: "'escape followed by crlf \\A\r\n'"},
				{Type: parser.TokenDone},
			},
		},
		{ // 4
			...
			[]parser.Token{
				{Type: TokenString, Data: "'escape followed by newline \\AaFf01\n'"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenString, Data: "'escape followed by carriage return \\AaFf01\r'"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenString, Data: "'escape followed by form feed \\AaFf01\f'"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenString, Data: "'escape followed by crlf \\AaFf01\r\n'"},
				{Type: parser.TokenDone},
			},
		},
		{ // 5
		...
		{ // 6
			...
			[]parser.Token{
				{Type: TokenBadString, Data: "'escape followed by newline \\AaFf012\n"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenBadString, Data: "'escape followed by carriage return \\AaFf012\r"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenBadString, Data: "'escape followed by form feed \\AaFf012\f"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenBadString, Data: "'escape followed by crlf \\AaFf012\r\n"},
				{Type: parser.TokenDone},
			},
		},
		{ // 7
			...
			[]parser.Token{
				{Type: TokenBadString, Data: "'bad string\n"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenBadString, Data: "'bad string\r"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenBadString, Data: "'bad string\f"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenBadString, Data: "'bad string\r\n"},
				{Type: parser.TokenDone},
			},
		...
		{ // 8
			...
			[]parser.Token{
				...
				{Type: TokenIdent, Data: "abc"},
				{Type: TokenDelim, Data: "\\"},
				{Type: TokenWhitespace, Data: "\r "},
				{Type: TokenIdent, Data: "abc"},
				{Type: TokenDelim, Data: "\\"},
				{Type: TokenWhitespace, Data: "\f "},
				{Type: TokenIdent, Data: "abc"},
				{Type: TokenDelim, Data: "\\"},
				{Type: TokenWhitespace, Data: "\r\n"},
				{Type: parser.TokenDone},
		...
		{ // 9
			...
			[]parser.Token{
				{Type: TokenBadURL, Data: "url(a\\\nb)"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenBadURL, Data: "url(a\\\rb)"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenBadURL, Data: "url(a\\\fb)"},
				{Type: TokenWhitespace, Data: " "},
				{Type: TokenBadURL, Data: "url(a\\\r\\\nb)"},
				{Type: parser.TokenDone},
			},
